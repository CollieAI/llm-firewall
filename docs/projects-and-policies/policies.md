...
curl -X POST https://api.collieai.com/api/v1/policies \
...
curl -X POST https://api.collieai.com/api/v1/policies/{policy_id}/set-default \
  -H "Authorization: Bearer clai_..."
```
...
curl -X PATCH https://api.collieai.com/api/v1/projects/{project_id} \
  -H "Authorization: Bearer clai_..." \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X DELETE https://api.collieai.com/api/v1/policies/{policy_id} \
  -H "Authorization: Bearer clai_..."
```
...
```bash
curl https://api.collieai.com/api/v1/policies \
  -H "Authorization: Bearer clai_..."
```
...
```bash
curl https://api.collieai.com/api/v1/policies/{policy_id} \
  -H "Authorization: Bearer clai_..."
```
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/policies/{policy_id} \
  -H "Authorization: Bearer clai_..." \
  -H "Content-Type: application/json" \
  -d '{
    "name": "renamed-policy",
...
curl https://api.collieai.com/api/v1/projects/{project_id}/policy \
  -H "Authorization: Bearer clai_..."
```
...
curl -X POST https://api.collieai.com/api/v1/policies/{pii_policy_id}/set-default \
  -H "Authorization: Bearer clai_..."
