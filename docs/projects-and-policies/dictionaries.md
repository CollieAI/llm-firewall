...
```bash
curl -X PUT https://api.collieai.com/api/v1/dictionaries/{dictionary_id} \
  -H "Authorization: Bearer clai_..." \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/dictionaries/{dictionary_id} \
  -H "Authorization: Bearer clai_..."
```
...
```bash
curl -X POST https://api.collieai.com/api/v1/policies/{policy_id}/rules \
  -H "Authorization: Bearer clai_..." \
  -H "Content-Type: application/json" \
  -d '{
