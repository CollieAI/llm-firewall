...
This rule evaluates every inbound message and reports triggers, but does not block anything. Once validated, update the rule to `inherit` or `enforce` to activate it:
