...
**URL:** `https://api.collieai.com/api/v1/tokens`
...
```bash
curl https://api.collieai.com/api/v1/tokens \
...
```bash
curl -X POST https://api.collieai.com/api/v1/tokens \
  -H "Authorization: Bearer <token>" \
...
**URL:** `https://api.collieai.com/api/v1/tokens/{token_id}`
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/tokens/tok_abc123 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/tokens/tok_abc123 \
  -H "Authorization: Bearer <token>"
```
