...
**URL:** `https://api.collieai.com/api/v1/projects/{project_id}/api-keys`
...
```bash
curl https://api.collieai.com/api/v1/projects/proj_abc123/api-keys \
...
```bash
curl -X POST https://api.collieai.com/api/v1/projects/proj_abc123/api-keys \
  -H "Authorization: Bearer <token>" \
...
**URL:** `https://api.collieai.com/api/v1/projects/{project_id}/api-keys/{key_id}`
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/projects/proj_abc123/api-keys/key_abc123 \
  -H "Authorization: Bearer <token>"
```
