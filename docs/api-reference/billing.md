...
**URL:** `https://api.collieai.com/api/v1/billing/subscription`
...
**URL:** `https://api.collieai.com/api/v1/billing/checkout`
...
**URL:** `https://api.collieai.com/api/v1/billing/portal`
...
**URL:** `https://api.collieai.com/api/v1/billing/webhook`
