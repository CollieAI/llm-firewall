...
**URL:** `https://api.collieai.com/auth/login`
...
**URL:** `https://api.collieai.com/auth/email/login`
...
```bash
curl -X POST https://api.collieai.com/auth/email/login \
...
**URL:** `https://api.collieai.com/auth/set-password`
...
```bash
curl -X POST https://api.collieai.com/auth/set-password \
...
**URL:** `https://api.collieai.com/auth/google/authorize`
...
**URL:** `https://api.collieai.com/auth/google/callback`
...
**URL:** `https://api.collieai.com/auth/me`
...
```bash
curl https://api.collieai.com/auth/me \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/auth/ip-allowlist`
...
```bash
curl https://api.collieai.com/auth/ip-allowlist \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl -X PUT https://api.collieai.com/auth/ip-allowlist \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
**URL:** `https://api.collieai.com/auth/logout`
...
```bash
curl -X POST https://api.collieai.com/auth/logout \
  -H "Authorization: Bearer <token>"
```
