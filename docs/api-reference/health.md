...
**URL:** `https://api.collieai.com/api/v1/health`
...
```bash
curl https://api.collieai.com/api/v1/health
```
...
**URL:** `https://api.collieai.com/api/v1/health/ready`
...
```bash
curl https://api.collieai.com/api/v1/health/ready
```
...
**URL:** `https://api.collieai.com/api/v1/health/live`
...
```bash
curl https://api.collieai.com/api/v1/health/live
```
...
**URL:** `https://api.collieai.com/api/v1/health/models`
...
```bash
curl https://api.collieai.com/api/v1/health/models
```
...
**URL:** `https://api.collieai.com/api/v1/health/queues`
