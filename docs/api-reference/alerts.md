...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/rules`
...
```bash
curl -X POST https://api.collieai.com/api/v1/alerts/projects/proj_abc123/rules \
...
```bash
curl https://api.collieai.com/api/v1/alerts/projects/proj_abc123/rules \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/rules/{rule_id}`
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/alerts/projects/proj_abc123/rules/alert_rule_abc123 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
    "threshold": 0.30,
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/alerts/projects/proj_abc123/rules/alert_rule_abc123 \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/events`
...
```bash
curl "https://api.collieai.com/api/v1/alerts/projects/proj_abc123/events?limit=10&offset=0" \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/events/{event_id}/acknowledge`
...
```bash
curl -X POST https://api.collieai.com/api/v1/alerts/projects/proj_abc123/events/evt_abc123/acknowledge \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/events/acknowledge-all`
...
```bash
curl -X POST https://api.collieai.com/api/v1/alerts/projects/proj_abc123/events/acknowledge-all \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/alerts/projects/{project_id}/unread-count`
...
```bash
curl https://api.collieai.com/api/v1/alerts/projects/proj_abc123/unread-count \
  -H "Authorization: Bearer <token>"
```
