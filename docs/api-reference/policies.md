...
**URL:** `https://api.collieai.com/api/v1/policies`
...
**URL:** `https://api.collieai.com/api/v1/policies/{policy_id}`
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/policies/pol_abc123 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/policies/pol_abc123 \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/policies/{policy_id}/set-default`
...
```bash
curl -X POST https://api.collieai.com/api/v1/policies/pol_abc123/set-default \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl https://api.collieai.com/api/v1/projects/proj_abc123/policies \
  -H "Authorization: Bearer <token>"
```
