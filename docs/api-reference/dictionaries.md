...
**URL:** `https://api.collieai.com/api/v1/dictionary-groups`
...
```bash
curl https://api.collieai.com/api/v1/dictionary-groups \
...
**URL:** `https://api.collieai.com/api/v1/dictionary-groups/{group_id}`
...
```bash
curl https://api.collieai.com/api/v1/dictionary-groups/grp_abc123 \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/dictionaries`
...
```bash
curl https://api.collieai.com/api/v1/dictionaries \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/dictionaries/system`
...
```bash
curl https://api.collieai.com/api/v1/dictionaries/system \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl -X POST https://api.collieai.com/api/v1/dictionaries \
  -H "Authorization: Bearer <token>" \
...
**URL:** `https://api.collieai.com/api/v1/dictionaries/upload`
...
```bash
curl -X POST https://api.collieai.com/api/v1/dictionaries/upload \
  -H "Authorization: Bearer <token>" \
  -F "file=@wordlist.txt" \
...
**URL:** `https://api.collieai.com/api/v1/dictionaries/extract`
...
```bash
curl -X POST https://api.collieai.com/api/v1/dictionaries/extract \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
**URL:** `https://api.collieai.com/api/v1/dictionaries/{dictionary_id}`
...
```bash
curl -X PUT https://api.collieai.com/api/v1/dictionaries/dict_abc123 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/dictionaries/dict_abc123 \
  -H "Authorization: Bearer <token>"
```
