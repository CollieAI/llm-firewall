...
**URL:** `https://api.collieai.com/api/v1/admin/stats`
...
```bash
curl https://api.collieai.com/api/v1/admin/stats \
...
**URL:** `https://api.collieai.com/api/v1/admin/users`
...
```bash
curl "https://api.collieai.com/api/v1/admin/users?search=john&page=1&page_size=10" \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/admin/users/{user_id}`
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/admin/users/usr_abc123 \
  -H "Authorization: Bearer <token>" \
...
**URL:** `https://api.collieai.com/api/v1/admin/dictionaries`
...
```bash
curl https://api.collieai.com/api/v1/admin/dictionaries \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl -X POST https://api.collieai.com/api/v1/admin/dictionaries \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "PCI DSS Terms",
...
**URL:** `https://api.collieai.com/api/v1/admin/dictionaries/{dictionary_id}`
...
```bash
curl -X PUT https://api.collieai.com/api/v1/admin/dictionaries/dict_sys003 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
    "content": "credit card\ncard number\ncvv\nexpiration date\ncardholder\nPAN\nIBAN"
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/admin/dictionaries/dict_sys003 \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/admin/policies`
...
```bash
curl https://api.collieai.com/api/v1/admin/policies \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl -X POST https://api.collieai.com/api/v1/admin/policies \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
**URL:** `https://api.collieai.com/api/v1/admin/policies/{policy_id}`
...
```bash
curl -X PATCH https://api.collieai.com/api/v1/admin/policies/pol_sys003 \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/admin/policies/pol_sys003 \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/admin/policies/{policy_id}/rules`
...
```bash
curl https://api.collieai.com/api/v1/admin/policies/pol_sys001/rules \
  -H "Authorization: Bearer <token>"
```
...
**URL:** `https://api.collieai.com/api/v1/admin/policies/{policy_id}/rules/{rule_id}`
...
```bash
curl -X DELETE https://api.collieai.com/api/v1/admin/policies/pol_sys001/rules/rule_sys001 \
  -H "Authorization: Bearer <token>"
```
