...
**URL:** `https://api.collieai.com/v1/chat/completions`
...
| ------ | --------------------- | ---------------------------------------- |
| `400`  | `content_blocked`     | Inbound message blocked by policy rule   |
| `400`  | `response_blocked`    | Outbound response blocked by policy rule |
...
**URL:** `https://api.collieai.com/v1/models`
...
```bash
curl https://api.collieai.com/v1/models \
  -H "Authorization: Bearer clai_your_api_key"
```
